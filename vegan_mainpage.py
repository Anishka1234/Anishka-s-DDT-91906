...
menu_restaurant_2_reviews.add_command(label="VIEW REVIEWS", command=lambda: open_window("atelier_display_review.py"))
review_button_2.bind("<Button-1>", lambda event: show_menu(event, menu_restaurant_1_reviews))
