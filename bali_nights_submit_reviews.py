...
def open_reviews():
    subprocess.Popen(['python', 'bali_nights_submit_reviews.py'])
...
def open_submit_reviews():
    ...
    script_path = 'bali_nights_submit_reviews.py'
...
def submit_review():
    ...
    if review_text != '' and username:
        ...
        try:
            ...
            if response == 'yes':
                user_review.delete(0, 'end')  # Clear the entry for the next review
