...
menu_restaurant_1_reviews.add_command(label="ADD REVIEW",
                                      command=lambda: open_window("melba_vulcan_submit_reviews.py"))
menu_restaurant_1_reviews.add_command(label="VIEW REVIEWS",
                                      command=lambda: open_window("melba_vulcan_display_reviews.py"))
...
review_button_3.bind("<Button-1>", lambda event: show_menu(event, menu_restaurant_3_reviews))

# Navigation buttons

# 'Forward' button that navigates and allows the user to be directed to the next pae of restaurants
...
# 'Home' button that navigates to the user's home page
button_image_home = PhotoImage(file=relative_to_assets("home.png"))
button_home = Button(image=button_image_home, borderwidth=0, highlightthickness=0,
                     command=lambda: open_landing(), relief="flat")
button_home.place(x=1176.0, y=32.0, width=80.0, height=81.0)
...
canvas.create_text(1012.0, 788.0, anchor="nw", text="◉ Gluten-free", fill="#000000", font=("Inter ExtraLightItalic",
                                                                                           12))
